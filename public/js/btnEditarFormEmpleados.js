...
// const btnEliminarEmpleadoModal = document.querySelector("#btnEliminarEmpleadoModal");

// btnEliminarEmpleadoModal.addEventListener("click", async() => {

//     console.log("me diste click en si ")
//     const id = btnEliminarEmpleadoModal.dataset.id
//     console.log("id", id)
//     try {
...
//         body: JSON.stringify({ nombre, apellido, cedula, sexo, estatus, departamento, nacimiento, lugarNacimiento, nacionalidad, sueldoBruto, afp, ars, cooperativa, club, prestamos, totalDescuentos, sueldoNeto })
//     })
